    ...
    $(function () {
        $("#submit_01").submit(function () {
            ...
            $.ajax({
                ...
                dataType: "json",
                url: "/compYearStatistics/getDetailExcel",
...
<div class="action  divaction">
	...
	<div class="pages">
		<s:form action="/compYearStatistics/getDetailExcel" name="queryForm">
		...
		<table width="90%" border="0" cellspacing="0" cellpadding="0" class="list items">
	      ...
	      <c:forEach items="${compYearDetail}" var="deptClaimVoucher" begin="0" varStatus="s">
	      <tr>
